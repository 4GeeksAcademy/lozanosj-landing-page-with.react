	...
	return (
		<div class="container-fluid col-8 d-flex justify-content-center">
			...
			<div class="col p-2 mt-3">
				<div class="card h-100">
					<img src="https://picsum.photos/536/354" class="card-img-top" alt="por qué"/>
						<div class="card-body">
							<h5 class="card-title text-center">Card title</h5>
			...
			<div class="col p-2 mt-3">
				<div class="card h-100">
					<img src="https://picsum.photos/536/354" class="card-img-top" alt="no salen"/>
						<div class="card-body">
							<h5 class="card-title text-center">Card title</h5>
			...
			<div class="col ps-2 pt-2 pb-2 mt-3">
				<div class="card h-100">
					<img src="https://picsum.photos/536/354" class="card-img-top" alt="las imágenes"/>
						<div class="card-body">
							<h5 class="card-title text-center">Card title</h5>
